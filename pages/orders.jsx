  ...
  return (
    <div className='bg-gray-100 min-h-screen'>
      ...
      <div className='p-4'>
        ...
        <ul>
            {data.map((order, id)=>{
                return <li key={id} className='bg-gray-50 hover:bg-gray-100 rounded-lg my-3 p-2 grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer'>
                        <div className='flex '>
